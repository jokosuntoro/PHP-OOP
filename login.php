...
{	$username = strip_tags(addslashes(trim($_POST['username']))); 
	...
	{	$login = $users->login($username, $password);
		if ($login === false) {
			...
			$users->log_users($login,'Login ke dalam sistem');
			echo $login;
...
<br/><br/>
<h1 class="loginform">Login Sistem PHP OOP</h1>
<div class="loginform" align="center">
	<table class="loginform">
	<tr><td>
		<img src="images/login3.jpg" alt="Company-Logo" align="middle">
	</td>
	<td>
		<form name="login" method="post">
		<fieldset><legend>&nbsp;Silakan Log In&nbsp;</legend>
